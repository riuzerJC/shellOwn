...
StyledWindow {
    ...
    WlrLayershell.keyboardFocus: screenState.launcher || screenState.appCatalog || screenState.session || screenState.dashboard || (screenState.workspaceOverlay && workspaceOverlayEnabled) ? WlrKeyboardFocus.OnDemand : WlrKeyboardFocus.None
